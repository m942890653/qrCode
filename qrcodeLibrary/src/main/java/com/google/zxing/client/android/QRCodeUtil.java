...
public class QRCodeUtil {
     ...
     */
    @Nullable
    public static Bitmap createQRCodeBitmap(@NonNull String content, int size) {
        return createQRCodeBitmap(content, size, "utf-8", ErrorCorrectionLevel.Q.toString(), "4", Color.BLACK, Color.WHITE, null, null, 0F);
    }
     ...
     */
    @Nullable
    public static Bitmap createQRCodeBitmap(@NonNull String content, int size, @ColorInt int color_black, @ColorInt int color_white) {
        return createQRCodeBitmap(content, size, "utf-8", ErrorCorrectionLevel.H.toString(), "4", color_black, color_white, null, null, 0F);
    }
     ...
     */
    @Nullable
    public static Bitmap createQRCodeBitmap(@NonNull String content, int size, @Nullable Bitmap logoBitmap, float logoPercent) {
        return createQRCodeBitmap(content, size, "utf-8", ErrorCorrectionLevel.H.toString(), "4", Color.BLACK, Color.WHITE, null, logoBitmap, logoPercent);
    }
     ...
     */
    @Nullable
    public static Bitmap createQRCodeBitmap(@NonNull String content, int size, Bitmap targetBitmap) {
        return createQRCodeBitmap(content, size, "utf-8", ErrorCorrectionLevel.H.toString(), "4", Color.BLACK, Color.WHITE, targetBitmap, null, 0F);
    }
     ...
     */
    @Nullable
    public static Bitmap createQRCodeBitmap(@Nullable String content,
                                            int size,
     ...
     */
    @Nullable
    public static String scanBitmap(@NonNull Bitmap bitmap) {
